 ...
 * @author jgald
 */
public class FormularioInsertarMulta extends javax.swing.JDialog {
    ...
    public FormularioInsertarMulta(java.awt.Frame parent, boolean modal,
            ListaDobleMultas listaMultas, JTable tablaMultas,
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INGRESE LOS DATOS DE LA MULTA");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try {
            ...
            if (departamento.isEmpty() || placa.isEmpty() || fecha.isEmpty() || descripcion.isEmpty()) {
            ...
            // Crear objeto multa
            Multa nuevaMulta = new Multa(departamento, placa, fecha, descripcion, monto);
            listaMultas.agregarAlFinal(nuevaMulta);

            // Actualizar cantidad de multas en ABB y/o AVL
            if (nodoABB != null) {
            ...
            // Refrescar la tabla de multas
            DefaultTableModel modelo = (DefaultTableModel) tablaMultas.getModel();
            modelo.addRow(new Object[]{
                nuevaMulta.getDepartamento(),
                nuevaMulta.getPlaca(),
                nuevaMulta.getFecha(),
                nuevaMulta.getDescripcion(),
                nuevaMulta.getMonto()
            });
            ...
            JOptionPane.showMessageDialog(this, "Error en el monto. Ingrese un número válido.");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Error al insertar multa: " + ex.getMessage());
        }
